...
extension ProjectDashboardView {
    ...
    var projectOSAdaptiveIntentPanel: some View {
    ...
    @ViewBuilder
    func projectOSAdaptiveModeContent(_ intent: ProjectOSIntentSnapshot) -> some View {
        switch intent.mode {
    ...
    func projectOSIntentPlanningContent(_ intent: ProjectOSIntentSnapshot) -> some View {
    ...
    func projectOSIntentFileContent(_ intent: ProjectOSIntentSnapshot) -> some View {
        VStack(alignment: .leading, spacing: 7) {
            projectOSIntentDatum(
    ...
    func projectOSIntentCommandContent(_ intent: ProjectOSIntentSnapshot) -> some View {
        VStack(alignment: .leading, spacing: 7) {
            projectOSIntentDatum(
    ...
    func projectOSIntentApprovalContent(_ intent: ProjectOSIntentSnapshot) -> some View {
    ...
    func projectOSIntentRecoveryContent(_ intent: ProjectOSIntentSnapshot) -> some View {
        VStack(alignment: .leading, spacing: 7) {
            projectOSIntentDatum(
    ...
    func projectOSIntentProofContent(_ intent: ProjectOSIntentSnapshot) -> some View {
        VStack(alignment: .leading, spacing: 7) {
            projectOSIntentDatum(
                title: "Proof",
    ...
    func projectOSIntentIdleContent(_ intent: ProjectOSIntentSnapshot) -> some View {
        projectOSIntentDatum(
    ...
    func projectOSIntentObjectRow(_ intent: ProjectOSIntentSnapshot) -> some View {
    ...
    var projectOSIntentHistoryStrip: some View {
        VStack(alignment: .leading, spacing: 7) {
            HStack(spacing: 7) {
    ...
    var projectOSBriefColumns: [GridItem] {
    ...
    var projectOSCommandBriefPanel: some View {
        let tint = projectOSTint
