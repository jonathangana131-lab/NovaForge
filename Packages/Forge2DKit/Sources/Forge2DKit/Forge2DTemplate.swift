...
enum Forge2DTemplate {
    ...
    * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
    ...
    static func script(for blueprint: Forge2DBlueprint) -> String {
        ...
        const input = { keyboardLeft: false, keyboardRight: false, touchLeft: false, touchRight: false, gamepadAxis: 0, jumpQueued: false, gamepadJumpWasDown: false, gamepadPauseWasDown: false };
        ...
        function update(dt) {
          pollGamepad();
          const leftDown = input.keyboardLeft || input.touchLeft || input.gamepadAxis < -0.18;
          const rightDown = input.keyboardRight || input.touchRight || input.gamepadAxis > 0.18;
