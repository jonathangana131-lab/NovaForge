...
public enum Forge2DSemanticAutomationCapability: String, Codable, CaseIterable, Sendable {
...
public struct Forge2DGeneratedProject: Equatable, Sendable {
    ...
    public let semanticAutomationCapabilities: Set<Forge2DSemanticAutomationCapability>
    ...
    public init(
        ...
        semanticAutomationCapabilities: Set<Forge2DSemanticAutomationCapability> = []
    ) {
