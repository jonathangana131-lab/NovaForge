...
public enum Forge2DGenerator {
    ...
    private static func html(for blueprint: Forge2DBlueprint) -> String {
        ...
        <body>
          <main id="game-shell" data-novaforge-action="move-horizontal" aria-label="\#(safeTitle)">
            ...
            <button id="pause" class="pause" type="button" data-novaforge-control="pause" aria-pressed="false" aria-label="Pause game">Ⅱ</button>
            ...
            <div class="controls controls-right" aria-label="Action controls">
              <button id="jump" type="button" data-novaforge-action="jump" aria-label="Jump">↑</button>
            </div>
          </main>
