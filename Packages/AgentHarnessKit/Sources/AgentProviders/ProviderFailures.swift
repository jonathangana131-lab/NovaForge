...
public enum ProviderFailureMapper {
    ...
    private static func httpPublicMessage(
        ...
        case 400, 404, 405, 409, 413, 422:
            return "The selected model or request format is not available on this provider. Refresh models in Control or choose another model."
        case 401:
            return "The saved provider key or login was rejected. Reconnect it in Control, then retry."
        case 402:
            return "This provider needs API billing or credits. Add API credit or choose another provider in Control."
        case 403:
            return "This account does not have access to the selected model. Refresh models or choose another provider in Control."
        case 408, 504:
            return "The provider took too long to answer. Retry once or choose another model."
        case 429:
            return "The provider is rate limiting this account. Wait a moment or choose another provider in Control."
        case 500 ... 599:
