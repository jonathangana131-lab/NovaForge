...
public enum Forge3DGenerator {
    public static func generate(_ blueprint: Forge3DBlueprint) throws -> Forge3DGeneratedProject {
        ...
        return Forge3DGeneratedProject(
            ...
            semanticAutomationCapabilities: [.activateControl, .setActionValue]
        )
    }
    ...
    private static func html(for blueprint: Forge3DBlueprint) -> String {
        ...
        <body>
          <main id="scene-shell" aria-label="\#(safeTitle)">
            ...
            <button id="pause" class="pause" type="button" data-novaforge-control="pause" aria-pressed="false" aria-label="Pause scene">Ⅱ</button>
            ...
            <div class="assistive-driving">
              ...
              <input id="accessible-throttle" type="range" data-novaforge-action="drive-throttle" min="-1" max="1" step="0.1" value="0">
              <label for="accessible-steer">Steering</label>
              <input id="accessible-steer" type="range" data-novaforge-action="drive-steering" min="-1" max="1" step="0.1" value="0">
            </div>
          </main>
