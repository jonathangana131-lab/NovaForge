...
public enum Forge3DGenerator {
    public static func generate(_ blueprint: Forge3DBlueprint) throws -> Forge3DGeneratedProject {
        ...
        return Forge3DGeneratedProject(
            ...
            semanticTargets: Forge3DSemanticTargetCatalog.all
        )
    }
    ...
    private static func html(for blueprint: Forge3DBlueprint) -> String {
        ...
        <body>
          <main id="scene-shell" aria-label="\#(safeTitle)">
            ...
            <button id="pause" class="pause" type="button" \#(Forge3DWebSemanticContract.controlAttribute)="\#(Forge3DSemanticTargetCatalog.pause.id)" aria-pressed="false" aria-label="Pause scene">Ⅱ</button>
            ...
            <div class="assistive-driving">
              ...
              <input id="accessible-throttle" \#(Forge3DWebSemanticContract.actionAttribute)="\#(Forge3DSemanticTargetCatalog.throttle.id)" type="range" min="-1" max="1" step="0.1" value="0">
              <label for="accessible-steer">Steering</label>
              <input id="accessible-steer" \#(Forge3DWebSemanticContract.actionAttribute)="\#(Forge3DSemanticTargetCatalog.steering.id)" type="range" min="-1" max="1" step="0.1" value="0">
            </div>
          </main>
