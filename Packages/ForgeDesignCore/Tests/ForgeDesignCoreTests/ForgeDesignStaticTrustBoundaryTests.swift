...
final class ForgeDesignStaticTrustBoundaryTests: XCTestCase {
    ...
    func testExternalConsumerCannotMintUserMutationAuthority() throws {
        try assertExternalCompilationRejected(
            ...
            func attemptMint(_ before: DesignDNA, _ after: DesignDNA, _ record: DesignDNAChangeRecord, _ purpose: DesignDNAUserMutationPurpose) {
    ...
    func testExternalConsumerCannotMintTransitionTrust() throws {
        try assertExternalCompilationRejected(
            ...
            func attemptMint(_ before: DesignDNA, _ after: DesignDNA, _ record: DesignDNAChangeRecord) throws {
    ...
    private func activeModulesURL() throws -> URL {
        ...
        throw NSError(
            ...
            code: 1,
            userInfo: [NSLocalizedDescriptionKey: "ForgeDesignCore module is missing from the active SwiftPM test bundle/executable ancestry"]
        )
    }
}
